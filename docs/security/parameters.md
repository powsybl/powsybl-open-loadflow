...
The `contingencyPropagation` property is applicable only to Node/Breaker network models.
For Bus/Breaker network models, Security Analysis simulates the outage of only the equipment(s) defined in the contingency.
