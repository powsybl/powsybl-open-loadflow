...
public class ReductionEngine {
    ...
    public void run() {
        ...
        ReductionResults reductionResults = new ReductionResults(tmMinusYeq);
        ybb.processResults(rowVectorToDouble(tmMinusIeq), reductionResults);
        reductionResults.printReductionResults();
    }
    ...
    private double[] rowVectorToDouble(Matrix m1) {
        DenseMatrix m1d = m1.toDense();
    ...
    private void computeCurrentInjections(VoltageInitializer voltageInitializer, EquationSystem equationSystem) {
