...
public abstract class AbstractLfBus extends AbstractElement implements LfBus {
    ...
    void setShuntCompensators(List<ShuntCompensator> shuntCompensators, LfNetworkParameters parameters, NominalVoltageMapping nominalVoltageMapping) {
        if (!parameters.isShuntVoltageControl() && !shuntCompensators.isEmpty()) {
            shunt = new LfShuntImpl(shuntCompensators, network, this, false, parameters, nominalVoltageMapping);
        } else {
            ...
            if (!controllerShuntCompensators.isEmpty()) {
                controllerShunt = new LfShuntImpl(controllerShuntCompensators, network, this, true, parameters, nominalVoltageMapping);
            }
            ...
            if (!fixedShuntCompensators.isEmpty()) {
                shunt = new LfShuntImpl(fixedShuntCompensators, network, this, false, parameters, nominalVoltageMapping);
            }
        }
    }
