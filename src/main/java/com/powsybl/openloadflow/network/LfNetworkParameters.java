...
public class LfNetworkParameters {
    ...
    public static final boolean USE_FICTITIOUS_INJECTIONS_DEFAULT_VALUE = true;
    ...
    private boolean useFictitiousInjections = USE_FICTITIOUS_INJECTIONS_DEFAULT_VALUE;
    ...
    public LfNetworkParameters(LfNetworkParameters other) {
        ...
        this.extrapolateReactiveLimits = other.extrapolateReactiveLimits;
        this.useFictitiousInjections = other.useFictitiousInjections;
    }
    ...
    public LfNetworkParameters setUseFictitiousInjections(boolean useFictitiousInjections) {
    ...
    public String toString() {
        return "LfNetworkParameters(" +
                ...
                ", useFictitiousInjections=" + useFictitiousInjections +
                ')';
    }
}
