...
public class AsymBranch {
    ...
    public AsymBranch(SimplePiModel piZeroComponent, SimplePiModel piPositiveComponent, SimplePiModel piNegativeComponent,
    ...
    // Three phase description of the equipment through the three phase admittance matrix
    public AsymBranch(ComplexMatrix yabc, boolean phaseOpenA, boolean phaseOpenB, boolean phaseOpenC,
                      ...
                      AsymBusVariableType side1VariableType, AsymBusVariableType side2VariableType) { //, boolean isPositiveSequenceAsCurrent1, boolean isPositiveSequenceAsCurrent2) {
