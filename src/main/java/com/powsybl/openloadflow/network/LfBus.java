...
public interface LfBus extends LfElement {
    ...
    void setZeroImpedanceNetwork(LoadFlowModel type, LfZeroImpedanceNetwork zeroImpedanceNetwork);

    LfZeroImpedanceNetwork getZeroImpedanceNetwork(LoadFlowModel type);
}
