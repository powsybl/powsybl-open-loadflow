...
public abstract class AbstractLfBranch extends AbstractElement implements LfBranch {
    ...
    private boolean discreteVoltageControlEnabled;
    ...
    @Override
    public void setDiscreteVoltageControlEnabled(boolean enabled) {
        if (this.discreteVoltageControlEnabled != enabled) {
            this.discreteVoltageControlEnabled = enabled;
    ...
    @Override
    public boolean isDiscreteVoltageControllerEnabled() {
        return discreteVoltageControlEnabled;
    }
}
