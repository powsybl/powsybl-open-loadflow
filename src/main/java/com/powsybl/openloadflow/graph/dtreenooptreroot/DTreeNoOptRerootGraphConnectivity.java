 ...
 */
public class DTreeNoOptRerootGraphConnectivity<V, E> extends AbstractGraphConnectivity<V, E, DTGraph<V, E>> implements SpanningForestGraphConnectivity<V, E> {

    public DTreeNoOptRerootGraphConnectivity() {
        super(new DTGraph<>());
    }
