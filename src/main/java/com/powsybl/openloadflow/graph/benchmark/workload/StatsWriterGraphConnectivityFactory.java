 ...
 */
public class StatsWriterGraphConnectivityFactory<V, E> implements ISpyGraphConnectivityFactory<V, E> {

    private final GraphConnectivityFactory<V, E> delegateFactory;
    private final Output output;

    public StatsWriterGraphConnectivityFactory(GraphConnectivityFactory<V, E> delegateFactory, Output output) {
    ...
    @Override
    public ISpyGraphConnectivity<V, E> create(int threadId, int networkId) {
        output.setOperations("T" + threadId + "-N" + networkId + ".txt");
        return createImpl();
    }

    private ISpyGraphConnectivity<V, E> createImpl() {
        Path path;
        try {
        ...
        StatsWriterGraphConnectivity<V, E> conn = new StatsWriterGraphConnectivity<>(path);
