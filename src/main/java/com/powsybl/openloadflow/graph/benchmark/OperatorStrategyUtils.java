...
import com.powsybl.openloadflow.graph.benchmark.ng.Edge;
import com.powsybl.openloadflow.graph.benchmark.ng.Vertex;
...
public class OperatorStrategyUtils {
    ...
    /*private static void checkSame(Set<Vertex> vertices, GraphConnectivity<Vertex, Edge> expected, GraphConnectivity<Vertex, Edge> current) {
        Assertions.assertEquals(expected.getNbConnectedComponents(), current.getNbConnectedComponents());
        Assertions.assertEquals(expected.getLargestConnectedComponent(), current.getLargestConnectedComponent());
        ...
        for (Vertex v : vertices) {
            if (!done.contains(v)) {
                ...
                Assertions.assertEquals(compExpected, compCurrent);
                done.addAll(compExpected);
            }
        }

        Assertions.assertEquals(expected.getVerticesRemovedFromMainComponent(), current.getVerticesRemovedFromMainComponent());
        Assertions.assertEquals(expected.getVerticesAddedToMainComponent(), current.getVerticesAddedToMainComponent());
        Assertions.assertEquals(expected.getEdgesAddedToMainComponent(), current.getEdgesAddedToMainComponent());
        Assertions.assertEquals(expected.getEdgesRemovedFromMainComponent(), current.getEdgesRemovedFromMainComponent());
    }*/
