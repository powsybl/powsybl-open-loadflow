 ...
 */
public class DTreeSetRootGraphConnectivity<V, E> extends AbstractGraphConnectivity<V, E, DTGraph<V, E>> implements SpanningForestGraphConnectivity<V, E> {

    public DTreeSetRootGraphConnectivity() {
        super(new DTGraph<>());
    }
