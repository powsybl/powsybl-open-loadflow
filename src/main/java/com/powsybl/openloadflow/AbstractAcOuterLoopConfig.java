...
public abstract class AbstractAcOuterLoopConfig implements AcOuterLoopConfig {
    ...
    public static Optional<AcOuterLoop> createDistributedSlackOuterLoop(LoadFlowParameters parameters, OpenLoadFlowParameters parametersExt) {
    ...
    protected static Optional<AcOuterLoop> createTransformerVoltageControlOuterLoop(LoadFlowParameters parameters,
                                                                                    ...
                                                                                    int transformerVoltageControlHtLimit,
        ...
        if (parameters.isTransformerVoltageControlOn()) {
            AcOuterLoop outerLoop = switch (controlMode) {
                ...
                case AFTER_GENERATOR_VOLTAGE_CONTROL -> new TransformerVoltageControlOuterLoop(isTransformerVoltageControlStable, transformerVoltageControlHtLimit);
