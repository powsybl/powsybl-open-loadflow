...
public class OpenLoadFlowParameters extends AbstractExtension<LoadFlowParameters> {
    ...
    public static final boolean FAST_DC_SECURITY_ANALYSIS_DEFAULT_VALUE = false;
    ...
    public static final String FAST_DC_SECURITY_ANALYSIS_PARAM_NAME = "fastDcFastSecurityAnalysis";
    ...
    public static final List<Parameter> SPECIFIC_PARAMETERS = List.of(
        ...
        new Parameter(FAST_DC_SECURITY_ANALYSIS_PARAM_NAME, ParameterType.BOOLEAN, "Fast dc security analysis", FAST_DC_SECURITY_ANALYSIS_DEFAULT_VALUE)
    );
    ...
    private boolean fastDcSecurityAnalysis = FAST_DC_SECURITY_ANALYSIS_DEFAULT_VALUE;
    ...
    public boolean getFastDcSecurityAnalysis() {
        return fastDcSecurityAnalysis;
    }

    public OpenLoadFlowParameters setFastDcSecurityAnalysis(boolean fastDcSecurityAnalysis) {
        this.fastDcSecurityAnalysis = fastDcSecurityAnalysis;
        return this;
    }
    ...
    public static OpenLoadFlowParameters load(PlatformConfig platformConfig) {
        ...
        platformConfig.getOptionalModuleConfig("open-loadflow-default-parameters")
            .ifPresent(config -> parameters
                ...
                .setFastDcSecurityAnalysis(config.getBooleanProperty(FAST_DC_SECURITY_ANALYSIS_PARAM_NAME, FAST_DC_SECURITY_ANALYSIS_DEFAULT_VALUE)));
        return parameters;
    }
    ...
    public OpenLoadFlowParameters update(Map<String, String> properties) {
        ...
        Optional.ofNullable(properties.get(FAST_DC_SECURITY_ANALYSIS_PARAM_NAME))
                .ifPresent(prop -> this.setFastDcSecurityAnalysis(Boolean.parseBoolean(prop)));
        return this;
    }
    ...
    public Map<String, Object> toMap() {
        ...
        map.put(FAST_DC_SECURITY_ANALYSIS_PARAM_NAME, fastDcSecurityAnalysis);
        return map;
    }
    ...
    public static boolean equals(LoadFlowParameters parameters1, LoadFlowParameters parameters2) {
        ...
        return extension1.getSlackBusSelectionMode() == extension2.getSlackBusSelectionMode() &&
                ...
                extension1.getFastDcSecurityAnalysis() == extension2.getFastDcSecurityAnalysis();
    }
    ...
    public static LoadFlowParameters clone(LoadFlowParameters parameters) {
        ...
        if (extension != null) {
            OpenLoadFlowParameters extension2 = new OpenLoadFlowParameters()
                    ...
                    .setFastDcSecurityAnalysis(extension.getFastDcSecurityAnalysis());
