...
public class OpenLoadFlowParameters extends AbstractExtension<LoadFlowParameters> {
    ...
    public static final String SLACK_DISTRIBUTION_GENERATORS_VOLTAGE_CONTROL_ONLY_PARAM_NAME = "slackDistributionGeneratorVoltageControlOnly";
    ...
    public static final List<Parameter> SPECIFIC_PARAMETERS = List.of(
        ...
        new Parameter(SLACK_DISTRIBUTION_GENERATORS_VOLTAGE_CONTROL_ONLY_PARAM_NAME, ParameterType.BOOLEAN, "When set to true and if distributing slack on generators, only generators on voltage control will participate in slack distribution", LfNetworkParameters.SLACK_DISTRIBUTION_GENERATORS_VOLTAGE_CONTROL_ONLY_DEFAULT_VALUE)
    );
    ...
    private boolean slackDistributionGeneratorsVoltageControlOnly = LfNetworkParameters.SLACK_DISTRIBUTION_GENERATORS_VOLTAGE_CONTROL_ONLY_DEFAULT_VALUE;
    ...
    public OpenLoadFlowParameters setSlackDistributionGeneratorsVoltageControlOnly(boolean slackDistributionGeneratorsVoltageControlOnly) {
    ...
    public static OpenLoadFlowParameters load(PlatformConfig platformConfig) {
        ...
        platformConfig.getOptionalModuleConfig("open-loadflow-default-parameters")
            .ifPresent(config -> parameters
                ...
                .setSlackDistributionGeneratorsVoltageControlOnly(config.getBooleanProperty(SLACK_DISTRIBUTION_GENERATORS_VOLTAGE_CONTROL_ONLY_PARAM_NAME, LfNetworkParameters.SLACK_DISTRIBUTION_GENERATORS_VOLTAGE_CONTROL_ONLY_DEFAULT_VALUE)));
        return parameters;
    }
    ...
    public OpenLoadFlowParameters update(Map<String, String> properties) {
        ...
        Optional.ofNullable(properties.get(SLACK_DISTRIBUTION_GENERATORS_VOLTAGE_CONTROL_ONLY_PARAM_NAME))
                .ifPresent(prop -> this.setSlackDistributionGeneratorsVoltageControlOnly(Boolean.parseBoolean(prop)));
        return this;
    }

    public Map<String, Object> toMap() {
        Map<String, Object> map = new LinkedHashMap<>(69);
        ...
        map.put(SLACK_DISTRIBUTION_GENERATORS_VOLTAGE_CONTROL_ONLY_PARAM_NAME, slackDistributionGeneratorsVoltageControlOnly);
        return map;
    }
    ...
    static LfNetworkParameters getNetworkParameters(LoadFlowParameters parameters, OpenLoadFlowParameters parametersExt,
        ...
        return new LfNetworkParameters()
                ...
                .setSlackDistributionGeneratorsVoltageControlOnly(parametersExt.isSlackDistributionGeneratorsVoltageControlOnly());
    }
    ...
    public static boolean equals(LoadFlowParameters parameters1, LoadFlowParameters parameters2) {
        ...
        return extension1.getSlackBusSelectionMode() == extension2.getSlackBusSelectionMode() &&
                ...
                extension1.isSlackDistributionGeneratorsVoltageControlOnly() == extension2.isSlackDistributionGeneratorsVoltageControlOnly();
    }
    ...
    public static LoadFlowParameters clone(LoadFlowParameters parameters) {
        ...
        if (extension != null) {
            OpenLoadFlowParameters extension2 = new OpenLoadFlowParameters()
                    ...
                    .setSlackDistributionGeneratorsVoltageControlOnly(extension.isSlackDistributionGeneratorsVoltageControlOnly());
