...
public class OpenLoadFlowParameters extends AbstractExtension<LoadFlowParameters> {
    ...
    public static final List<Parameter> SPECIFIC_PARAMETERS = List.of(
        ...
        new Parameter(FICTITIOUS_GENERATOR_VOLTAGE_CONTROL_MODE, ParameterType.STRING, "Specificies how fictitious generators can voltage. Possible modes are 'always' and 'normal'. 'always', the default, means that voltage is controlled even if targetP is outside of minP and maxP.", OpenLoadFlowParameters.FICTITIOUS_GENERATOR_VOLTAGE_CONTROL_MODE_DEFAULT_VALUE.name(), getEnumPossibleValues(FictitiousGeneratorVoltageControlMode.class))
    );
