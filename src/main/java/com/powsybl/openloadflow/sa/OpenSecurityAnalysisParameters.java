    ...
    public static OpenSecurityAnalysisParameters load(PlatformConfig platformConfig) {
        ...
        platformConfig.getOptionalModuleConfig("open-security-analysis-default-parameters")
                .ifPresent(config -> parameters
                        ...
                        .setContingencyPartitioningMode(config.getEnumProperty(CONTINGENCY_PARTITIONING_MODE_PARAM_NAME, ContingencyPartitioningMode.class, CONTINGENCY_PARTITIONING_MODE_DEFAULT_VALUE)));
        return parameters;
    }
