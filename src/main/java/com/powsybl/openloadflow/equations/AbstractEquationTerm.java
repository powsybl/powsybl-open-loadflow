 ...
 */
public abstract class AbstractEquationTerm<V extends Enum<V> & Quantity, E extends Enum<E> & Quantity> implements SingleEquationTerm<V, E> {
    ...
    protected SingleEquationTerm<V, E> self = this;
