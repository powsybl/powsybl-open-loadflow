 ...
 */
public class EquationSystemImpl<V extends Enum<V> & Quantity, E extends Enum<E> & Quantity> implements EquationSystem<V, E> {
    ...
    public EquationSystemImpl() {
        this(false);
    }

    public EquationSystemImpl(boolean indexTerms) {
    ...
    private Equation<V, E> addEquation(Pair<Integer, E> p) {
        Equation<V, E> equation = new Equation<>(p.getLeft(), p.getRight(), EquationSystemImpl.this);
