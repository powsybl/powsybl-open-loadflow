...
public class JacobianMatrix<V extends Enum<V> & Quantity, E extends Enum<E> & Quantity>
    ...
    public JacobianMatrix(EquationSystem<V, E> equationSystem, EquationEvaluator equationEvaluator, MatrixFactory matrixFactory) {
    ...
    private void initMatrix() {
        ...
        equationEvaluator.initDer((column, row, value) -> matrix.addAndGetIndex(row, column, value));
    ...
    private void updateValues(boolean allowIncrementalUpdate) {
        ...
        matrix.reset();
        equationEvaluator.updateDer((elementIndex, value) -> matrix.addAtIndex(elementIndex, value));
