...
public final class ParameterConstants {
    ...
    public static final String REMAINS_LOAD_POWER_FACTOR_CONSTANT_PARAM_NAME = "remainsLoadPowerFactorConstant";
    public static final boolean REMAINS_LOAD_POWER_FACTOR_CONSTANT_DEFAULT_VALUE = false;
