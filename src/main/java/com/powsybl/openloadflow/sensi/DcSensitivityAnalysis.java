...
public class DcSensitivityAnalysis extends AbstractSensitivityAnalysis {
    ...
    protected DenseMatrix setReferenceActivePowerFlows(LfNetwork network, EquationSystem equationSystem, LUDecomposition lu, List<LfSensitivityFactor<ClosedBranchSide1DcFlowEquationTerm>> factors,
    ...
    private void setPredefinedResults(Collection<LfSensitivityFactor<ClosedBranchSide1DcFlowEquationTerm>> lfFactors, GraphDecrementalConnectivity<LfBus> connectivity, int mainComponent) {
        for (LfSensitivityFactor<ClosedBranchSide1DcFlowEquationTerm> factor : lfFactors) {
