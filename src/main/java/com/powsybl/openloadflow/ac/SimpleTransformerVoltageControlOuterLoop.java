 ...
 */
public class SimpleTransformerVoltageControlOuterLoop implements OuterLoop {

    private static final Logger LOGGER = LoggerFactory.getLogger(SimpleTransformerVoltageControlOuterLoop.class);
