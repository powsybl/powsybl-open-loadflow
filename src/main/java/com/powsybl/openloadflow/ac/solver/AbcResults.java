...
public class AbcResults {
    ...
    public void addBusAbcResult(LfBus bus) {
        ...
        System.out.println(" PU PHASE A = " + busVa.get(bus).abs() + " (" + Math.toDegrees(busVa.get(bus).getArgument()));
        System.out.println(" PU PHASE B = " + busVb.get(bus).abs() + " (" + Math.toDegrees(busVb.get(bus).getArgument()));
        System.out.println(" PU PHASE C = " + busVc.get(bus).abs() + " (" + Math.toDegrees(busVc.get(bus).getArgument()));
    }
