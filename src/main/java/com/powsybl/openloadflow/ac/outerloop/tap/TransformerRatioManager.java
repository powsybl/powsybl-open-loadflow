...
public class TransformerRatioManager {
     ...
     * @param stable
     */
    public TransformerRatioManager(AcOuterLoopContext context, boolean stable) {
        this.stable = stable;
    ...
    /**
     * I the ratio of a group of parallel transformers is above the max of the group
     * freezes the transformer to its max.
     * If stable mode is false, considers the max of the inidividual transformer.
     * @param transfo
