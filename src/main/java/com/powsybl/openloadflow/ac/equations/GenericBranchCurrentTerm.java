...
public final class GenericBranchCurrentTerm {
    ...
    public static double dtxdv1(int i, int j, int g, int h,
        ...
        // tx = ri * rj * vhj * (yxijgh * Math.cos(aj - ai + thhj) - Yyijgh * Math.sin(aj - ai + thhj));
        if (j == 1 && h == 1) {
    ...
    public static double dtxda1(int i, int j, int g, int h,
        ...
        ///// tx = ri * rj * vgi * vhj * (yxijgh * Math.cos(ai - aj + thgi - thhj) - yyijgh * Math.sin(ai - aj + thgi - thhj)) ;
        // tx = ri * rj * vhj * (yxijgh * Math.cos(aj - ai + thhj) - Yyijgh * Math.sin(aj - ai + thhj));
        if (i == 1 && g == 1 && j == 1 && h == 1) { // TODO : check if only direct component, not sure...
            return 0;
        } else if (i == 1 && g == 1) {
            return ri * rj * vhj * (-yxijgh * Math.sin(aj - ai + thhj) + yyijgh * Math.cos(aj - ai + thhj));
        } else if (j == 1 && h == 1) {
    ...
    public static double dtydv1(int i, int j, int g, int h,
                                double ri, double rj, double ai, double aj, double vgi, double vhj, double thgi, double thhj, double yxijgh, double yyijgh) {
        ////// ty = ri * rj * vgi * vhj * (yxijgh * Math.sin(ai - aj + thgi - thhj) + yyijgh * Math.cos(ai - aj + thgi - thhj));
        // ty = ri * rj * vhj * (yxijgh * Math.sin(aj - ai + thhj) + Yyijgh * Math.cos(aj - ai + thhj));
        if (j == 1 && h == 1) {
