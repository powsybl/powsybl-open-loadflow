 ...
 */
public class LoadModelActiveFlowFastDecoupledEquationTerm implements AbstractFastDecoupledEquationTerm {

    private final LoadModelActiveFlowEquationTerm term;

    public LoadModelActiveFlowFastDecoupledEquationTerm(LoadModelActiveFlowEquationTerm loadModelActiveFlowEquationTerm) {
        this.term = loadModelActiveFlowEquationTerm;
    }
