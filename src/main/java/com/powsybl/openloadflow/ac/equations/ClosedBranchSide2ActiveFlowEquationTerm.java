...
public class ClosedBranchSide2ActiveFlowEquationTerm extends AbstractClosedBranchAcFlowEquationTerm {
    ...
    public void update(double[] x, StateVectorContext context) {
        ...
        double sinTheta = context.sinPh1MinusPh2PlusC(ph1Var.getRow(), ph2Var.getRow(), cosC, sinC);
        double cosTheta = context.cosPh1MinusPh2PlusC(ph1Var.getRow(), ph2Var.getRow(), cosC, sinC);
