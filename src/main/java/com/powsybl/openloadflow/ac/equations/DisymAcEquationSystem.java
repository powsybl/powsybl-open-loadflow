 ...
 */
public final class DisymAcEquationSystem {

    private DisymAcEquationSystem() {
    }
    ...
    private static List<EquationTerm<AcVariableType, AcEquationType>> createReactiveTerms(LfBus controllerBus,
                                                                                          VariableSet<AcVariableType> variableSet, DisymAcEquationSystemCreationParameters creationParameters) {
    ...
    public static void updateGeneratorVoltageControl(VoltageControl voltageControl, EquationSystem<AcVariableType, AcEquationType> equationSystem) {
        ...
        if (firstControllerBus.hasGeneratorsWithSlope()) {
            ...
            if (voltageControl.isVoltageControlLocal()) {
                ...
                DisymAcEquationSystem.updateRemoteVoltageControlEquations(voltageControl, equationSystem);
            }
        }
    }
    ...
    private static boolean isDeriveA1(LfBranch branch, DisymAcEquationSystemCreationParameters creationParameters) {
    ...
    public static EquationSystem<AcVariableType, AcEquationType> create(LfNetwork network) {
        return create(network, new DisymAcEquationSystemCreationParameters());
    }
    ...
    public static EquationSystem<AcVariableType, AcEquationType> create(LfNetwork network,
        ...
        network.addListener(new DisymAcEquationSystemUpdater(equationSystem));
