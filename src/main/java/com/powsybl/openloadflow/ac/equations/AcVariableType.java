...
public enum AcVariableType implements Quantity {
    ...
    BUS_V_ZERO("vh", ElementType.BUS), // bus voltage magnitude
    BUS_PHI_ZERO("\u03C6h", ElementType.BUS), // bus voltage angle
    BUS_V_NEGATIVE("vi", ElementType.BUS), // bus voltage magnitude
    BUS_PHI_NEGATIVE("\u03C6i", ElementType.BUS), // bus voltage angle
