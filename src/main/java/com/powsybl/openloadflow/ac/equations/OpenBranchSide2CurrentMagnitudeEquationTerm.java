...
public class OpenBranchSide2CurrentMagnitudeEquationTerm extends AbstractOpenSide2BranchAcFlowEquationTerm {
    ...
    private static double reI2(double y, double cosKsi, double sinKsi, double g1, double b1, double g2, double b2, double v1, double ph1, double r1) {
    ...
    private static double imI2(double y, double cosKsi, double sinKsi, double g1, double b1, double g2, double b2, double v1, double ph1, double r1) {
        double shunt = shunt(y, cosKsi, sinKsi, g2, b2);
        return r1 * r1 * v1 * (gres(y, sinKsi, g1, g2, b2, shunt) * FastMath.sin(ph1) + bres(y, cosKsi, b1, g2, b2, shunt) * FastMath.cos(ph1));
    }

    private static double i2(double y, double cosKsi, double sinKsi, double g1, double b1, double g2, double b2, double v1, double ph1, double r1) {
        return FastMath.hypot(reI2(y, cosKsi, sinKsi, g1, b1, g2, b2, v1, ph1, r1), imI2(y, cosKsi, sinKsi, g1, b1, g2, b2, v1, ph1, r1));
    }

    private static double dreI2dv1(double y, double cosKsi, double sinKsi, double g1, double b1, double g2, double b2, double ph1, double r1) {
        double shunt = shunt(y, cosKsi, sinKsi, g2, b2);
        return r1 * r1 * (gres(y, sinKsi, g1, g2, b2, shunt) * FastMath.cos(ph1) - bres(y, cosKsi, b1, g2, b2, shunt) * FastMath.sin(ph1));
    }

    private static double dimI2dv1(double y, double cosKsi, double sinKsi, double g1, double b1, double g2, double b2, double ph1, double r1) {
        double shunt = shunt(y, cosKsi, sinKsi, g2, b2);
        return r1 * r1 * (gres(y, sinKsi, g1, g2, b2, shunt) * FastMath.sin(ph1) + bres(y, cosKsi, b1, g2, b2, shunt) * FastMath.cos(ph1));
    }

    private static double di2dv1(double y, double cosKsi, double sinKsi, double g1, double b1, double g2, double b2, double v1, double ph1, double r1) {
        return (reI2(y, cosKsi, sinKsi, g1, b1, g2, b2, v1, ph1, r1) * dreI2dv1(y, cosKsi, sinKsi, g1, b1, g2, b2, ph1, r1)
                + imI2(y, cosKsi, sinKsi, g1, b1, g2, b2, v1, ph1, r1) * dimI2dv1(y, cosKsi, sinKsi, g1, b1, g2, b2, ph1, r1)) / i2(y, cosKsi, sinKsi, g1, b1, g2, b2, v1, ph1, r1);
    }

    @Override
    public double eval() {
        return i2(y, FastMath.cos(ksi), FastMath.sin(ksi), g1, b1, g2, b2, v1(), ph1(), r1());
    }
    ...
    public double der(Variable<AcVariableType> variable) {
        ...
        if (variable.equals(v1Var)) {
            return di2dv1(y, FastMath.cos(ksi), FastMath.sin(ksi), g1, b1, g2, b2, v1(), ph1(), r1());
        } else {
