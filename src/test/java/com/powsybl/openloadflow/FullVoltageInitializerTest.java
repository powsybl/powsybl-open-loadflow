...
class FullVoltageInitializerTest {
    ...
    void testEsgTuto1() {
        ...
        FullVoltageInitializer initializer = new FullVoltageInitializer(new VoltageMagnitudeInitializer(matrixFactory),
                                                                        new DcValueVoltageInitializer(new LfNetworkParameters(slackBusSelector),
                                                                                                      false,
        ...
        assertBusVoltage(lfNetwork, initializer, "VLHV1_0", 1.0745, -2.511475);
        assertBusVoltage(lfNetwork, initializer, "VLHV2_0", 1.0745, -6.439649);
        assertBusVoltage(lfNetwork, initializer, "VLLOAD_0", 1.076, -12.61893);
    }
}
