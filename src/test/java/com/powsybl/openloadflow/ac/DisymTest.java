...
/*
    ...
    void fourNodesDissymTest() {
        ...
        assertVoltageEquals(100., bus1);
        assertAngleEquals(0, bus1);
        assertVoltageEquals(99.78656625947522, bus2); // balanced = 99.79736062173895
        assertAngleEquals(-0.34451266748355286, bus2); // balanced = -0.11482430885268813
        assertVoltageEquals(99.2688416600348, bus3); // balanced = 99.54462759204546
        assertAngleEquals(-1.2121634768022864, bus3); // balanced = -0.2590112700040258
        assertVoltageEquals(99.01603727374308, bus4); // balanced = 99.29252809145005
