    ...
    void testDisabledNonImpedantBranch() {
        ...
        AcLoadFlowParameters acLoadFlowParameters
                = OpenLoadFlowParameters.createAcParameters(network,
                                                            ...
                                                            true,
                                                            false);
        try (LfNetworkList lfNetworks = Networks.load(network, SimpleNominalVoltageMapping.NONE, acLoadFlowParameters.getNetworkParameters(), Collections.emptySet(), Set.of(c1), Reporter.NO_OP)) {
