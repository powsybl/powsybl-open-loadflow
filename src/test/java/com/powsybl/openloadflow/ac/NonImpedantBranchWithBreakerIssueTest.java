...
class NonImpedantBranchWithBreakerIssueTest {
    ...
    void busBreakerAndNonImpedantBranchIssue() {
        ...
        lfNetwork.updateState(new LfNetworkStateUpdateParameters(false, false, false, false, false, false, false, false, ReactivePowerDispatchMode.Q_EQUAL_PROPORTION, false, ReferenceBusSelectionMode.FIRST_SLACK, false, true));
