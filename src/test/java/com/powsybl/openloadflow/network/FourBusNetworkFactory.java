...
public class FourBusNetworkFactory extends AbstractLoadFlowNetworkFactory {
    ...
    public static Network createWithSeveralTransformerVoltageControls() {
        ...
        twt.newRatioTapChanger().setTapPosition(0).setRegulationTerminal(twt.getTerminal2()).setTargetV(230).setRegulating(true).setTargetDeadband(0.1).setLoadTapChangingCapabilities(true)
                .beginStep()
                .setX(0.1f)
                .setRho(1.2)
                .endStep()
        ...
        twt2.newRatioTapChanger().setTapPosition(0).setRegulationTerminal(twt2.getTerminal2()).setTargetV(93).setRegulating(true).setTargetDeadband(0.1).setLoadTapChangingCapabilities(true)
                .beginStep()
                .setX(0.1f)
                .setRho(1.2)
                .endStep()
        ...
        twt3.newRatioTapChanger().setTapPosition(0).setRegulationTerminal(twt3.getTerminal2()).setTargetV(93).setRegulating(true).setTargetDeadband(0.1).setLoadTapChangingCapabilities(true)
                .beginStep()
                .setX(0.1f)
                .setRho(1.2)
                .endStep()
