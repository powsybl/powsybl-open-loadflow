...
class LfSwitchTest {
    ...
    void setUp() {
        ...
        acLoadFlowParameters = OpenLoadFlowProvider.createAcParameters(network, new LoadFlowParameters(), Reporter.NO_OP,
                                                                       new DenseMatrixFactory(), new OpenLoadFlowParameters(), true);
