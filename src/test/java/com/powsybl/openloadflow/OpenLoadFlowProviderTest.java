...
class OpenLoadFlowProviderTest {
    ...
    void specificParametersTest() {
        ...
        assertEquals(44, provider.getSpecificParameters().size());
        LoadFlowParameters parameters = new LoadFlowParameters();
