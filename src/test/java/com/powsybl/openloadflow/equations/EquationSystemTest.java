...
class EquationSystemTest {
    ...
    void writeDcSystemTest() {
        ...
        EquationSystem<DcVariableType, DcEquationType> equationSystem = DcEquationSystem.create(network, new DcEquationSystemCreationParameters(true, false, false, true), LfNetworkParameters.LOW_IMPEDANCE_THRESHOLD_DEFAULT_VALUE);
        String ref = String.join(System.lineSeparator(),
                "bus_target_φ0 = φ0",
