...
class EquationSystemTest {
    ...
    void writeDcSystemTest() {
        ...
        EquationSystem<DcVariableType, DcEquationType> equationSystem = DcEquationSystem.create(network, new DcEquationSystemCreationParameters(true, false, false, true, new LfNetworkParameters().getLowImpedanceThreshold()));
        String ref = String.join(System.lineSeparator(),
                "bus_target_φ0 = φ0",
