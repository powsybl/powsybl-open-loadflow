...
class EquationSystemTest {
    ...
    void findLargestMismatchesTest() {
        ...
        AcTargetVector targets = new AcTargetVector(mainNetwork, equationSystem);
        EquationVector<AcVariableType, AcEquationType> fx = new EquationVector<>(equationSystem);
        fx.minus(targets);
        List<Pair<Equation<AcVariableType, AcEquationType>, Double>> largestMismatches = NewtonRaphson.findLargestMismatches(equationSystem, fx.getArray(), 3);
